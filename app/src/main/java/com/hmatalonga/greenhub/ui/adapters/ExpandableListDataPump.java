...
public class ExpandableListDataPump {
    public static HashMap<String, List<String>> getData(
        ...
        for (SensorDetails sensor : list) {
            ...
            details.add(fragment.getString(R.string.sensors_card_power) + ": "
                    + sensor.power + "mA");
            details.add(fragment.getString(R.string.sensors_card_iswakeup) + ": "
                    + (sensor.isWakeUpSensor ?
                    fragment.getString(R.string.yes) : fragment.getString(R.string.no)));
